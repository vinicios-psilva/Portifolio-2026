...
total_risco = len(df_filtrado[df_filtrado['RISCO_CALCULADO'] == 1])
...
cols_visualizacao = ['MATRÍCULA', 'NOME', 'CAPACITAÇÃO', 'TOTAL_FALTAS', 'MOTIVO_OCORRENCIA', 'RISCO_CALCULADO', 'ACAO_SUGERIDA']
